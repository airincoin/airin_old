...
{
    if(fLiteMode) return; // ignore all Airin related functionality
...
/*
    ...
    allow endless transaction that would bloat Airin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("airin-privatesend");
