    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("AIRIN-light"), QVariant("light"));
    ui->theme->addItem(QString("AIRIN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("AIRIN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("AIRIN-traditional"), QVariant("trad"));
