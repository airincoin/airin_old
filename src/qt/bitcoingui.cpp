    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Airin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Airin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and airin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Airin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Airin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Airin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Airin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Airin addresses"));
    ...
    openAction->setStatusTip(tr("Open a airin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Airin Core help message to get a list with possible Airin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Airin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Airin network", "", count));
}
...
{
    QString strTitle = tr("Airin Core"); // default title
