 ...
 *
 *   // network
 *   CAirinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.airincoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CAirinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: AirinNetwork
// //   -- signature requirements : Key1(User)
// class CAirinNetworkVariable : public CGovernanceObject
// {
// private:
