...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "AirinNetwork") type = AirinNetwork;
    if(strType == "AirinNetworkVariable") type = AirinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == AirinNetwork) s = "AirinNetwork";
    if(type == AirinNetworkVariable) s = "AirinNetworkVariable";
