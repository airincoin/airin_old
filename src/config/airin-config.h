/* src/config/airin-config.h.  Generated from airin-config.h.in by configure.  */
/* src/config/airin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef AIRIN_CONFIG_H

#define AIRIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/airincoin/airin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Airin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Airin Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "airincore"
