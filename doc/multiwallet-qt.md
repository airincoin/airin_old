...
Only requiring some minor changes is airin.cpp.
...
Changes to airin.cpp
----------------------
airin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
