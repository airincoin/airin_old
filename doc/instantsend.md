...
* WebSocket: [https://github.com/airincoin/insight-api-airin#web-socket-api](https://github.com/airincoin/insight-api-airin#web-socket-api) 
* API: [https://github.com/airincoin/insight-api-airin#instantsend-transactions](https://github.com/airincoin/insight-api-airin#instantsend-transactions) 
...
By default, the Airin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Airin Core daemon:
